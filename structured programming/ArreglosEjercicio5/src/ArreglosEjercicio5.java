...
//Hacer un programa que elimine un elemento en un arreglo (ordenado decrecientemente) de tamaño MAX=10.
...
public class ArreglosEjercicio5 {
	...
	public static void eliminar_valor(int arr[],int pos) {
		//esta bien?
		for(int i=pos;i>0;i--) {
			arr[i]=arr[i-1];
		}
