...
//Hacer un programa que dada la matriz de secuencias de caracteres definida y precargada elimine todas las secuencias que tienen orden descendente entre sus elementos.
public class Matrices {
	...
	public static void main(String [] args) {
		...
		char matCaracter[][]= {{' ','a',' ',' ',' ','e','f',' ','h','i',' ','k','n','ñ',' ','o','p',' ','r',' '},{' ','c','b','a',' ','e','f',' ','h','i',' ','c','b','a',' ','o','p',' ','r',' '},{' ','a','b','c',' ','e','f',' ','h','i',' ','c','b','a',' ','d','c',' ','r',' '},{' ','a','b','c',' ','e',' ',' ','d','c','a',' ','n','ñ',' ','z','x',' ','r',' '}};
		int inicio=0;
		int fila=0;
		int fin=-1;
		int pos=0;	
		...
		while(pos<MAXCOL-1) {
			...
			if(es_descendente(matCaracter,inicio,fin,fila)) {
	...
	public static boolean es_descendente(char mat[][],int inicio,int fin,int fila) {
		while((inicio<fin)&&(mat[fila][inicio]>mat[fila][inicio+1])) {
			inicio++;			
		}
	...
	public static boolean es_ascendente(char mat[][],int inicio,int fin,int fila) {
